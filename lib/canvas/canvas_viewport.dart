            ...
            child: Stack(
              children: [
                ValueListenableBuilder<bool>(
                  valueListenable:
                      context.read<DrawingContext>().repaintNotifier,
                ...
                CustomPaint(
                  isComplex: true,
                  size: Size(
                    context.watch<DrawingContext>().canvas.width,
                    context.watch<DrawingContext>().canvas.height,
                  ),
